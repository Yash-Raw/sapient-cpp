...
| 1a | Core + IO + CPU kernels | 96 unit tests ported; golden dumps bit-identical on arm64 and x86_64 | in progress — plans A (core), C (dense kernels) and D (quant kernels) implemented on feat/cpp-sp1a; plans E, B pending |
