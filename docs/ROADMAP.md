...
| 1a | Core + IO + CPU kernels | 96 unit tests ported; golden dumps bit-identical on arm64 and x86_64 | in progress — plans A (core) and C (dense kernels) implemented on feat/cpp-sp1a; plans D, E, B pending |
