...
| 1a | Core + IO + CPU kernels | 96 unit tests ported; golden dumps bit-identical on arm64 and x86_64 | complete — plans A, C, D, E, B implemented on feat/cpp-sp1a; next: sub-project 1b (CPU chat vertical slice) |
